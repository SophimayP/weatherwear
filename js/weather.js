...
Weather.getCurrent = function (city, callback) {
  var url = "http://openweathermap.org/data/2.1/find/city?q=" + encodeURIComponent(city) + "&APPID=3eae59415b980357f9de1ab9cc73bcc";
...
Weather.getForecast = function (city, callback) {
  var url = "http://openweathermap.org/data/2.1/forecast/city?q=" + encodeURIComponent(city) + "&APPID=3eae59415b980357f9de1ab9cc73bcc";
